...
var stickyHeader = function stickyHeader() {
  ...
  var siteHeader = document.getElementsByClassName('site-header')[0];
  var trigger = document.getElementsByClassName('large-hero__title')[0];
  ...
  var createHeaderWaypoint = function createHeaderWaypoint() {
    new Waypoint({
      element: trigger,
  ...
  var addHighlight = function addHighlight(item) {
    var linkID = item.getAttribute('data-matching-link');
    var matchingLink = document.getElementById(linkID);
    matchingLink.classList.add('is-highlighted');
  };
  var createLinkHighlightWaypoints = function createLinkHighlightWaypoints() {
    var _iteratorNormalCompletion2 = true;
    var _didIteratorError2 = false;
    var _iteratorError2 = undefined;
    ...
    try {
      ...
      for (var _iterator2 = pageSections[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        _loop();
      }
    } catch (err) {
      _didIteratorError2 = true;
...
(0, _revealOnScroll2.default)().init({
  offset: '75%',
